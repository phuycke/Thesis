...
instruction15 = visual.TextStim(win, text=instr15,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
instruction16 = visual.TextStim(win, text=instr16,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
instruction17 = visual.TextStim(win, text=instr17,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
instruction18 = visual.TextStim(win, text=instr18,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
instruction19 = visual.TextStim(win, text=instr19,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
instruction20 = visual.TextStim(win, text=instr20,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)

EndInstruction2 = visual.TextStim(win, text=EndInstr2,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)

BelowProd = visual.TextStim(win, text=BelowText, units = 'norm', color='Black',pos=(0,-.5), height = .05, flipHoriz=False)

timing6 = visual.TextStim(win, text=time1,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
timing7 = visual.TextStim(win, text=time2,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
timing8 = visual.TextStim(win, text=time3,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
timing9 = visual.TextStim(win, text=time4,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
timing10 = visual.TextStim(win, text=time5,units='norm',height=0.12, color='Black',pos=[0,0], alignHoriz='center',flipHoriz=False)
...
with open("3_Phase_2_PP_%02d_FailSave.txt" %proefpersoonNR, 'w') as f:
    ...
    try:
        ...
        for i in range(len(trialShuffle)):
            ...
            StimProduct = Newer + Product + ".png"
            product = visual.ImageStim(win, image= StimProduct, pos = [0,.4])

            ReferenceName = visual.TextStim(win, text= "%s" %refName, units = 'norm', color='Black',pos=(0,-.15), height = .08, flipHoriz=False)
            ReferencePrice = visual.TextStim(win, text= "%s euro" %refPrice, units = 'norm', color='Black',pos=(0,-.30), height = .08, flipHoriz=False)

            rectangle = visual.Rect(win, width = .05, height = .05, pos=(.85,.85), fillColor = 'springgreen')

            rating_scale = visual.RatingScale(win, acceptPreText="", acceptText = "Ok",labels=["1","4","7"],size = 1, pos=(0,-.6), textColor = 'black', lineColor = 'black', showValue= False, markerColor = 'black')
